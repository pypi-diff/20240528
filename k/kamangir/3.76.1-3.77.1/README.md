# Comparing `tmp/kamangir-3.76.1.tar.gz` & `tmp/kamangir-3.77.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "kamangir-3.76.1.tar", last modified: Sun May 26 21:55:22 2024, max compression
+gzip compressed data, was "kamangir-3.77.1.tar", last modified: Tue May 28 01:39:18 2024, max compression
```

## Comparing `kamangir-3.76.1.tar` & `kamangir-3.77.1.tar`

### file list

```diff
@@ -1,29 +1,29 @@
-drwxr-xr-x   0 kamangir   (502) staff       (20)        0 2024-05-26 21:55:22.748566 kamangir-3.76.1/
--rw-r--r--   0 kamangir   (502) staff       (20)     7048 2023-09-12 02:58:40.000000 kamangir-3.76.1/LICENSE
--rw-r--r--   0 kamangir   (502) staff       (20)       24 2024-05-20 04:50:43.000000 kamangir-3.76.1/MANIFEST.in
--rw-r--r--   0 kamangir   (502) staff       (20)     4223 2024-05-26 21:55:22.748022 kamangir-3.76.1/PKG-INFO
--rw-r--r--   0 kamangir   (502) staff       (20)     3270 2024-05-26 21:55:16.000000 kamangir-3.76.1/README.md
-drwxr-xr-x   0 kamangir   (502) staff       (20)        0 2024-05-26 21:55:22.742666 kamangir-3.76.1/kamangir/
-drwxr-xr-x   0 kamangir   (502) staff       (20)        0 2024-05-26 21:55:22.746314 kamangir-3.76.1/kamangir/.abcli/
--rw-r--r--   0 kamangir   (502) staff       (20)      183 2024-05-26 18:20:34.000000 kamangir-3.76.1/kamangir/.abcli/actions.sh
--rwxr-xr-x   0 kamangir   (502) staff       (20)      300 2024-05-26 18:20:34.000000 kamangir-3.76.1/kamangir/.abcli/kamangir.sh
-drwxr-xr-x   0 kamangir   (502) staff       (20)        0 2024-05-26 21:55:22.746979 kamangir-3.76.1/kamangir/.abcli/tests/
--rw-r--r--   0 kamangir   (502) staff       (20)      208 2024-05-26 18:20:34.000000 kamangir-3.76.1/kamangir/.abcli/tests/update.sh
--rw-r--r--   0 kamangir   (502) staff       (20)      210 2024-05-26 18:20:34.000000 kamangir-3.76.1/kamangir/.abcli/tests/version.sh
--rw-r--r--   0 kamangir   (502) staff       (20)      536 2024-05-26 18:20:34.000000 kamangir-3.76.1/kamangir/.abcli/update.sh
--rw-r--r--   0 kamangir   (502) staff       (20)      119 2024-05-26 21:55:15.000000 kamangir-3.76.1/kamangir/__init__.py
--rw-r--r--   0 kamangir   (502) staff       (20)      581 2024-05-21 02:51:14.000000 kamangir-3.76.1/kamangir/__main__.py
--rw-r--r--   0 kamangir   (502) staff       (20)     3884 2024-05-26 18:20:34.000000 kamangir-3.76.1/kamangir/content.py
--rw-r--r--   0 kamangir   (502) staff       (20)     1845 2024-05-25 20:41:57.000000 kamangir-3.76.1/kamangir/functions.py
--rw-r--r--   0 kamangir   (502) staff       (20)       89 2024-05-21 02:51:14.000000 kamangir-3.76.1/kamangir/logger.py
--rw-r--r--   0 kamangir   (502) staff       (20)       17 2024-05-21 02:51:14.000000 kamangir-3.76.1/kamangir/urls.py
-drwxr-xr-x   0 kamangir   (502) staff       (20)        0 2024-05-26 21:55:22.747397 kamangir-3.76.1/kamangir.egg-info/
--rw-r--r--   0 kamangir   (502) staff       (20)     4223 2024-05-26 21:55:22.000000 kamangir-3.76.1/kamangir.egg-info/PKG-INFO
--rw-r--r--   0 kamangir   (502) staff       (20)      495 2024-05-26 21:55:22.000000 kamangir-3.76.1/kamangir.egg-info/SOURCES.txt
--rw-r--r--   0 kamangir   (502) staff       (20)        1 2024-05-26 21:55:22.000000 kamangir-3.76.1/kamangir.egg-info/dependency_links.txt
--rw-r--r--   0 kamangir   (502) staff       (20)      204 2024-05-26 21:55:22.000000 kamangir-3.76.1/kamangir.egg-info/requires.txt
--rw-r--r--   0 kamangir   (502) staff       (20)        9 2024-05-26 21:55:22.000000 kamangir-3.76.1/kamangir.egg-info/top_level.txt
--rw-r--r--   0 kamangir   (502) staff       (20)       81 2024-05-22 02:19:52.000000 kamangir-3.76.1/pyproject.toml
--rw-r--r--   0 kamangir   (502) staff       (20)      203 2024-05-25 20:19:52.000000 kamangir-3.76.1/requirements.txt
--rw-r--r--   0 kamangir   (502) staff       (20)       38 2024-05-26 21:55:22.748719 kamangir-3.76.1/setup.cfg
--rw-r--r--   0 kamangir   (502) staff       (20)      376 2024-05-26 20:39:14.000000 kamangir-3.76.1/setup.py
...
### Comparing `kamangir-3.76.1/LICENSE` & `kamangir-3.77.1/LICENSE`

 * *Files identical despite different names*

### Comparing `kamangir-3.76.1/PKG-INFO` & `kamangir-3.77.1/PKG-INFO`
...
@@ -38,8 +38,8 @@
 ...
 ---
-built by [`abcli-9.32.1-current`](https://github.com/kamangir/awesome-bash-cli), based on [`kamangir-3.76.1`](https://github.com/kamangir/kamangir).
...
### Comparing `kamangir-3.76.1/README.md` & `kamangir-3.77.1/README.md`
...
### Comparing `kamangir-3.76.1/kamangir/.abcli/update.sh` & `kamangir-3.77.1/kamangir/.abcli/update.sh`

 * *Files identical despite different names*

### Comparing `kamangir-3.76.1/kamangir/__main__.py` & `kamangir-3.77.1/kamangir/__main__.py`

 * *Files identical despite different names*

### Comparing `kamangir-3.76.1/kamangir/content.py` & `kamangir-3.77.1/kamangir/content.py`

 * *Files identical despite different names*

### Comparing `kamangir-3.76.1/kamangir/functions.py` & `kamangir-3.77.1/kamangir/functions.py`

 * *Files identical despite different names*

### Comparing `kamangir-3.76.1/kamangir.egg-info/PKG-INFO` & `kamangir-3.77.1/kamangir.egg-info/PKG-INFO`
