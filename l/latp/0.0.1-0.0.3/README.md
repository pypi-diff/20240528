# Comparing `tmp/latp-0.0.1.tar.gz` & `tmp/latp-0.0.3.tar.gz`
...
## Comparing `latp-0.0.1.tar` & `latp-0.0.3.tar`
...
### Comparing `latp-0.0.1/latp/cli.py` & `latp-0.0.3/latp/cli.py`
...
### Comparing `latp-0.0.1/latp/config.yaml` & `latp-0.0.3/latp/config.yaml`
...
@@ -1,9 +1,9 @@
 tests:
-  test_path: "stp_test/"  # 测试用例所在目录
+  test_path: "test_case/"  # 测试用例所在目录
   keyword_expression: ""  # 用例过滤表达式，默认为空
   mark_expression: ""  # 用例标记表达式，默认为空
   module_pattern: "^test_.*$"  # 模块名称匹配模式（正则表达式）
   class_pattern: "^(Test.*|.*Test)$"  # 类名称匹配模式（正则表达式）
   function_pattern: "^(test.*|.*test)$"  # 函数/方法名称匹配模式（正则表达式）
 
 logging:
```

### Comparing `latp-0.0.1/latp/runner.py` & `latp-0.0.3/latp/runner.py`
...
### Comparing `latp-0.0.1/setup.py` & `latp-0.0.3/setup.py`
...
### Comparing `latp-0.0.1/test_case/test_latp1.py` & `latp-0.0.3/test_case/test_latp1.py`

 * *Files identical despite different names*

### Comparing `latp-0.0.1/test_case/test_latp2.py` & `latp-0.0.3/test_case/test_latp2.py`
