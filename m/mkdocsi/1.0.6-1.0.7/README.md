# Comparing `tmp/mkdocsi-1.0.6.tar.gz` & `tmp/mkdocsi-1.0.7.tar.gz`
...
## Comparing `mkdocsi-1.0.6.tar` & `mkdocsi-1.0.7.tar`
...
### Comparing `mkdocsi-1.0.6/PKG-INFO` & `mkdocsi-1.0.7/PKG-INFO`
...
### Comparing `mkdocsi-1.0.6/mkdocsi.egg-info/PKG-INFO` & `mkdocsi-1.0.7/mkdocsi.egg-info/PKG-INFO`
...
### Comparing `mkdocsi-1.0.6/setup.py` & `mkdocsi-1.0.7/setup.py`
