# Comparing `tmp/mkdocsi-1.0.8.tar.gz` & `tmp/mkdocsi-1.0.9.tar.gz`
...
## Comparing `mkdocsi-1.0.8.tar` & `mkdocsi-1.0.9.tar`
...
### Comparing `mkdocsi-1.0.8/PKG-INFO` & `mkdocsi-1.0.9/PKG-INFO`
...
### Comparing `mkdocsi-1.0.8/mkdocsi/__init__.py` & `mkdocsi-1.0.9/mkdocsi/__init__.py`
...
### Comparing `mkdocsi-1.0.8/mkdocsi.egg-info/PKG-INFO` & `mkdocsi-1.0.9/mkdocsi.egg-info/PKG-INFO`
...
### Comparing `mkdocsi-1.0.8/setup.py` & `mkdocsi-1.0.9/setup.py`
